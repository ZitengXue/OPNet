...
def register_all_cocoa(root="/data0/ziteng/Amodal-Segmentation-Based-on-Visible-Region-Segmentation-and-Shape-Prior-main/detectron2/datasets"):
...
_PREDEFINED_SPLITS_COCO_AMODAL_CLS = {
    ...
    "cocoa_cls_train_amodal": ("coco/train2014", "coco/amodal_cls_annotations/COCO_amodal_train2014_with_classes_amodal.json"),
...
def register_all_coco_amodal_cls(root="/data0/ziteng/Amodal-Segmentation-Based-on-Visible-Region-Segmentation-and-Shape-Prior-main/detectron2/datasets"):
...
def register_all_d2sa(root="/data0/ziteng/Amodal-Segmentation-Based-on-Visible-Region-Segmentation-and-Shape-Prior-main/detectron2/datasets"):
...
_PREDEFINED_SPLITS_KINS = {
    ...
    "kins_train_amodal": ("KINS/training/image_2", "KINS/instances_train_amodal.json"),
...
def register_all_kins(root="/data0/ziteng/Amodal-Segmentation-Based-on-Visible-Region-Segmentation-and-Shape-Prior-main/detectron2/datasets"):
