...
class ROIPooler(nn.Module):
    ...
    def forward(self, x, box_lists):
        ...
        pooler_fmt_boxes = convert_boxes_to_pooler_format(box_lists)#就是给boxes第一列加个维度 batch_idx
        ...
        )     #box_lists 两个batch的BOXes类    self.min_level 2    slef.max_level 5    self.canonical_box_size  224   self.canonical_level   4 #将proposal分配到不同的level上
        ...
        #level 是 0,1,2,3  x_level是四层的特征图
