...
class GeneralizedRCNN(nn.Module):
    ...
    def __init__(self, cfg):
        super().__init__()
        self._cfg = cfg                    #相比官方多的
        self.device = torch.device(cfg.MODEL.DEVICE)          #相比官方多的
    ...
    def forward(self, batched_inputs, do_postprocess=True):
        ...
        if self.proposal_generator:
            ...
            #只返回proposals 和 proposal_losses,没有那个objectness
            #proposals是bs个Instance类，包含num_instances,image_height,image_width,proposal_boxes一共1000个
        else:
